...
!function (c) {
    ...
    function t(c, h) {
        var h = h || {}, t = h.size ? "icon--" + h.size : "", p = "icon icon--" + c + " " + t + " " + (h["class"] || ""), l = "<svg class='icon__cnt'><use xlink:href='#" + c + "-icon' /></svg>", i = "<div class='" + p + "'>" + a(l, p) + "</div>";
        return i
    }
    ...
    function p() {
        for (var h = c.querySelectorAll("[data-icon]"), a = 0; a < h.length; a++) {
            var p = h[a], l = p.getAttribute("data-icon"), i = {
                "class": p.className,
